...
public class WebSecurity extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET,"/css/**", "/static/**","/js/**","/fonts/**","/images/**")
        .permitAll()
        ...
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/profile/*")
        .permitAll()
        .antMatchers(HttpMethod.POST, "/welcome/profile")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/logon/*")
        .permitAll()
        .antMatchers(HttpMethod.POST, "/welcome/calendar")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/calendar/*")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/appointment/*")
        .permitAll()
        .antMatchers(HttpMethod.POST, SecurityConstants.SIGN_UP_URL)
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/signin")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/signin/edgarttrr@gmail.com")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/service")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/welcome/register")
        .permitAll()
